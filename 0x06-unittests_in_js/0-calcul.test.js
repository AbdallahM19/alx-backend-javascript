...
describe('calculateNumber', () => {
  ...
  it('should return 5 when input is 2 and 3.7', () => {
    assert.strictEqual(calculateNumber(2, 3.7), 5);
  });

  it('should return 5 when input is 2.2 and 3.7', () => {
  ...
  it('should return 1 when input is 0.4 and 0.7', () => {
    assert.strictEqual(calculateNumber(0.4, 0.7), 1);
  });

  it('should return -2 when input is -1.4 and -1.4', () => {
    assert.strictEqual(calculateNumber(-1.4, -1.4), -2);
  });

  it('should return -2 when input is -1.5 and -1.4', () => {
